...
\begin{document}
%
\title{Assume-Guarantee Reasoning Environment Copilot (AGREE-Dog)}%Towards Explainable Compositional Reasoning}%Assume-Guarantee Reasoning Environment Copilot (AGREE-Dog)}
%
%\titlerunning{Assume-Guarantee Reasoning Environment Copilot (AGREE-Dog)}
% If the paper title is too long for the running head, you can set
% an abbreviated paper title here
%
\author{Amer Tahat\inst{1} \and
  Isaac Aumundson\inst{1} \and
  David Hardin\inst{1} \and
  Darren Cofer\inst{1}}
%
